...
touch /tmp/test/score-percentage-backup-$SAPID.txt
...
sed -e '1, 2d' < /tmp/test/score-percentage-$SAPID.txt > /tmp/test/score-percentage-backup-$SAPID.txt
#cat /tmp/test/score-percentage-$SAPID.txt
